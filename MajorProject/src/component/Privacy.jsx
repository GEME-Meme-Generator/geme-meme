    ...
    <div>
      ...
      >
        ...
        <blockquote className="blockquote mb-0">
          <p className="text-dark font-body text-center">
      ...
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Geme.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Geme, accessible from{" "}
              <a
                href="https://major-mukesh.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://major-mukesh.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: project39393@gmail.com</p>
          </li>
          <li>
            <p>By phone number: +91 8521764695</p>
          </li>
        </ul>
      </Container>
    </div>
